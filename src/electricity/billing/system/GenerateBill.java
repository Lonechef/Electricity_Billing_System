...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            area.setText("\tTorrent Power Limited\nELECTRICITY BILL GENERATED FOR THE MONTH\n\tOF "+month+", 2022\n\n\n");
            
            ResultSet rs = c.s.executeQuery("select * from customer where meter_no = '12023'");
            if(rs.next()){
         ...
         rs = c.s.executeQuery("select * from  meter_info where meter_no= '414560'");
            if(rs.next()){
                area.append("\n");
